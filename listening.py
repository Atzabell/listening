...
import ssl, sys, argparse, uuid, re
...
def main():
	...
	try:
		...
		print(f'[{INFO}] Https esta listandose en: {server_port}.') if ssl_support else print(f'[{INFO}] {server_port}.')
		...
		print(f'[{IMPORTANT}] Espera con paciencia todo ira bien')
